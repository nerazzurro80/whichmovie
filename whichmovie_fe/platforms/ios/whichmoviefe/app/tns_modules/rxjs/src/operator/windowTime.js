...
TimeSpanOnlyState();
{
    var subscriber = state.subscriber, windowTimeSpan = state.windowTimeSpan, window_5 = state.window;
    if (window_5) {
        window_5.complete();
    }
...
CreationState();
{
    ...
    var window_6 = subscriber.openWindow();
    var action = this;
    var context = { action: action, subscription: null };
    var timeSpanState = { subscriber: subscriber, window: window_6, context: context };
